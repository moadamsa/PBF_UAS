                        ...
                        <div key={index}>
                            {products.map((product, i) =>
                                <div className="media" key={i}>
                                    <Link to={`/users/product/${product.id}`}><img className="img-fluid" src={`${product.variants[0].images}`} alt="" /></Link>
                                    <div className="media-body align-self-center">
                                        ...
                                        <Link to={`/users/product/${product.id}`}><h6>{product.name}</h6></Link>
